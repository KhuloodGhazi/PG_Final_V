...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //com.example.pg.upload btn click listner
    ...
    private void updateWasWithNoImage(final String title, final String description, final String editPostId) {
        ...
        //image deleted com.example.pg.upload new image
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (uriTask.isSuccessful()){
                            //uri is recieved com.example.pg.upload to firebae
                            HashMap<String , Object> hashMap = new HashMap<>();
            ...
            raf.putBytes(data)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                //uri is recieve post is com.example.pg.upload to firbase

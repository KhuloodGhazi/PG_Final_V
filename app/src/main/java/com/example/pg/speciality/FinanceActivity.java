...
public class FinanceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("uploadPDF").child("finance");
...
//            editText.setText(data.getDataString());
    ...
    public void uploadToFirebase(Uri data) {
        ...
        StorageReference ref = storageReference.child("pdf/").child("finance/").child("upload" + System.currentTimeMillis() + ".pdf");
        ref.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(FinanceActivity.this, "File upload", Toast.LENGTH_LONG).show();
                        editText.setText("");

...
public class PostDetailActivity extends AppCompatActivity {
    ...
    String hisUid , pImage ,myUid ,myUsername , myName , myDp,
            postId , pLikes , hisDp , hisName, hisUsername ;
    ImageView pImageIv;
    TextView uNameTv, pTimeTv ,pTitleTv ,pDescriptionTv ,pLikeTv, pCommentsTv, pUsernameTV;
    ImageButton moreBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pUsernameTV = findViewById(R.id.uUsernameTv);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    pUsernameTV.setText(hisUsername);

...
public class ReligionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("uploadPDF").child("religion");
...
//            editText.setText(data.getDataString());
    ...
    public void uploadToFirebase(Uri data) {
        ...
        StorageReference ref = storageReference.child("pdf/").child("religion/").child("upload" + System.currentTimeMillis() + ".pdf");
        ref.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(ReligionActivity.this, "File upload", Toast.LENGTH_LONG).show();
                        editText.setText("");
